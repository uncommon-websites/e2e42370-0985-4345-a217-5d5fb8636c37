	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"After a decade working on classified programmes, I saw brilliant technologies languish because founders couldn't find investors who understood what they were building. We exist to change that."`}
			/>
